...
En esta imagen se pueden observar los elementos que se han desplegado con el namespace `metallb`:
...
De este modo, se ha podido comprobar que el **LoadBalancer** está equilibrando eficazmente el tráfico entre los pods, asegurando la alta disponibilidad del servicio.
